      ...
      <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
        ...
        <form>
          <div class="relative w-full mb-3">
            <input type="email" class="font-Stevens text-xs border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="Email" />
          </div>
          <div class="relative w-full mb-3">
            <input type="password" class="font-Stevens text-xs border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="Password" />
          </div>
          <div>
            <label class="flex cursor-pointer justify-end "><span className='font-Stevens text-xs'>don’t have account?  <Link to="/SignUp" className='text-blue-600 hover:underline'>SIGN UP</Link>  </span></label>
          </div>
          <div class="text-center mt-6">
            <button class="bg-blueGray-800 text-white active:bg-blueGray-600  bg-redlight-100 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full ease-linear transition-all duration-150 font-Collingar" type="button"> Sign In </button>
          </div>
        </form>
      </div>
    </div>
