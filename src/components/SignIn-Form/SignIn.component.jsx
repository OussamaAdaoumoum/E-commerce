...
import { signInWithGoogle, signInWithEmailAndPassword } from "../../assets/firebase/firebase";
    ...
    <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-[#D9D9D9] border-0">
      <div class="rounded-t mb-0 px-6 py-6">
        ...
        <div class="btn-wrapper text-center">
          ...
          <button class="bg-white active:bg-blueGray-50 text-blueGray-700 px-4 py-2 rounded outline-none focus:outline-none mr-1 mb-1 uppercase shadow hover:shadow-md inline-flex items-center font-bold text-xs ease-linear transition-all duration-150" type="button" onClick={signInWithGoogle}>
      ...
      <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
        ...
        <form>
          ...
          <div class="text-center mt-6">
            <button class="bg-blueGray-800 text-white active:bg-blueGray-600  bg-redlight-100 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full ease-linear transition-all duration-150 font-Collingar" 
              type="submit"
              onClick={() => {
