    ...
    
   {
    ...
    stock.map((item) => {
        return (
              ...
              <div className="flex flex-wrap w-full justify-around text-black" key={item.cartId}>
        <div className="flex flex-wrap w-9/12 items-center justify-around border-4 border-double border-t-redlight-200">
          <img src={item.details.pic1} alt="StockImage" className="w-298 h-452 rounded-lg" />
