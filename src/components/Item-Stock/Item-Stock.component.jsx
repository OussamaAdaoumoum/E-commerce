    ...
    <>
      {stock &&
        stock.map((item) => {
          return (
            <div
              className="flex flex-wrap w-full justify-around text-black"
              key={item.cartId}
            >
              <div className="flex flex-wrap w-9/12 items-center justify-around border-4 border-double border-t-redlight-200">
                ...
                <div className="flex flex-wrap flex-col place-self-start">
                  ...
                  <div className="flex flex-wrap items-center flex-col font-Helvetica-bold">
                    ...
                    <button className=" transition duration-500 text-redlight-100  bg-redlight-200 rounded-lg text-sm px-3 lg:px-4.75 py-1 lg:py-1 mr-0.5 hover:text-white dark:hover:text-white hover:bg-redlight-200 focus:outline-none">
                      DELETE
                    </button>
                  </div>
                </div>
